...
public class Connectionsutil {
	...
	//This Class is where we manage and establish our database connection
		...
		public static Connection getConnection() throws SQLException {//this method establishes a database connection
			//the throws will catch anything that goes wrong on the sql end
			...
			try {
				Class.forName("org.postgresql.Driver"); //searching for the postgresql driver, which we have as a dependency
			...
			String url = "jdbc:postgresql://localhost:5432/postgres?currentSchema=new_efik_translator";
